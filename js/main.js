...
//         $("#sem_" + i)
//           .contents()
//           .find(".credits")[0].value = semesterMarks[i - 1].credits;
//         $("#sem_" + i)
//           .contents()
//           .find(".cgpa")[0].value = semesterMarks[i - 1].cgpa;
//       }
...
//         '</strong></div>\
//             <div class="alert alert-primary" role="alert">Total Credits: <strong>' +
